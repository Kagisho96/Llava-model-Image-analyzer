...
if chat_input := st.chat_input("What would you like to ask?"):
    ...
    #     st.write(":orange[Analyzing Image File...]")
        ...
        stream = analyze_image_file( model=image_model, user_prompt=chat_input)
...
# import streamlit as st
# from config import Config
# # from helpers.image_helper import create_temp_file  <-- not needed anymore
# from helpers.llm_helper import get_answer  
...
#         # calls the Mistral model for question and answer processing
#         answer = get_answer(question=chat_input, model=image_model)
